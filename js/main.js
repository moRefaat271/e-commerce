//------------------------------------------------------------------------------------------//
var AsmImg = ['imgs/phone2.png', 'imgs/scin.jpg', 'imgs/3.webp', 'imgs/4.jpg', 'imgs/5.jpg', 'imgs/6.webp'];
var categories = ['Smart Phones', 'Scin Care', 'images/3.webp', 'images/4.jpg', 'images/5.jpg', 'images/6.webp'];

//*create images cards
var lef = 0
for (let i = 0; i < AsmImg.length; i++) {
    document.getElementById("asCont").innerHTML +=
        `<div class="A_card" style="left:${lef}px;">
...
//&images change 
var newImg = ['imgs/phone.jpg', 'imgs/1.webp', 'imgs/2.webp', 'imgs/5.jpg', 'imgs/4.jpg', 'imgs/2.webp'];
...
for (i = 0; i < document.getElementsByClassName("A_imgs").length; i++) {
    (function (i) {
       document.getElementsByClassName("A_imgs")[i].onmouseover = function () {
         ...
         $(".A_imgs").eq(i).fadeTo(200,0.1,function (){
